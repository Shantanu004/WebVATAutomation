...
import UtilitiesPackageForVAT.GenerateExtentReport;
import UtilitiesPackageForVAT.Utilities;

public class ListenerFor_VAT_Automation implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String ScreenshotFolder= Utilities.captureScreenshotMethodForBatchSetUpPage(driver, result.getName());
