...
public class HomePageOfVat {
	...
	@FindBy(linkText = "Basic Setup")
	private WebElement ClickOnBasicSetup;
	...
	//SetUp Module
    public BasicSetupPage HomePageToNavigateBasicSetup() {
		NavigationBarClick.click();
		ClickOnSetup.click();
		ClickOnBasicSetup.click();
    	return new BasicSetupPage(driver);
    }
